...
<body oncontextmenu="return false">
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="BagPackDropDown.jsp" class="logo"><img src="TravelMate_Logo.png" width="60" height="50"> <b>Travel Mate</b></a>
            <div class="top-menu">
...
%>
      ...
      <section id="main-content">
          ...
          <button onclick="goBack()" class="btn btn-info btn-xs">Go Back</button>
          	...
          	<h3><i class="fa fa-angle-right"></i> BagPack</h3>
...
%>
                  ...
                  <form method="method" action="BagPackDropAction.jsp">
