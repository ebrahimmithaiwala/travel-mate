...
%>
      ...
      <section id="main-content">
          ...
          <button onclick="goBack()" class="btn btn-info btn-xs">Go Back</button>
          	...
          	<h3><i class="fa fa-angle-right"></i> Update Delete Products</h3>
             ...
             %>
               ...
               <center><input type="submit" name="action" value="Select" class="btn btn-success">
                          ...
                          <h4>Update Inventory</h4>
                           <form method="POST" action="UpdateDeleteTravelInventoryAction.jsp" enctype="multipart/form-data">
<%
...
<input type="hidden" name="TravelName" value="<%=TravelName%>">
...
<form method="POST" action="UpdateDeleteTravelInventoryAction.jsp" enctype="multipart/form-data">
                              ...
                              <tr>
                                ...
                                <div class="form-group">
                                  ...
                                  <option><%=ti.getProductCategory() %></option>
                                  ...
                                  <td><img src="<%=ProductPic %>" id="blah" alt="your image" width="100" height="100" />
                                  
                                  <input type="file" capture="camera" value="<%=ProductPic %>" name="ProductPic" class="form-control"></td>
                                  
                                  <td><input type="text" value="<%=ti.getProductName()%>" name="ProductName" class="form-control"></td>
                                  <td><input type="number" value="<%=ti.getProductQuantity()%>" name="ProductQuantity" class="form-control"></td>

                                  <td>
                                      <input type="submit" name="action" value="Update Inventory" class="btn btn-success btn-xs">
                                      <input type="submit" name="action" value="Delete Inventory" class="btn btn-success btn-xs">
                                      
                                      <input type="reset" class="btn btn-primary btn-xs"> 
                                      
                                      <input type="hidden" name="Id" value="<%=ti.getId()%>">
                                      <input type="hidden" name="UserName" value="<%=UserName%>">
                                      <input type="hidden" name="TravelName" value="<%=TravelName%>">
                                  </td>
                                      </div>
