...
%>
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="AddTravel.jsp" class="logo"><img src="TravelMate_Logo.png" width="60" height="50"> <b>Travel Mate</b></a>
            <div class="top-menu">
...
%>
      ...
      <section id="main-content">
          ...
          <button onclick="goBack()" class="btn btn-info btn-xs">Go Back</button>
          	<h3><i class="fa fa-angle-right"></i> Add Travel History</h3>
          	
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  
                      <form method="POST" action="AddTravelHistoryAction.jsp" class="form-horizontal style-form">
...
%>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="TravelName" class="form-control" placeholder="Travel Name">
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" name="TravelLocation" class="form-control" placeholder="Travel Location">
                              </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="date" name="TravelStartDate" class="form-control" id="startDate" min="<%=dt.now() %>" onblur="limitDate2()">
                              </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <input type="date" name="TravelEndDate" class="form-control" id="endDate">
                              </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="ModeOfTransportation" class="form-control" placeholder="Mode of Transport">
                              </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="TravelDetails" class="form-control" placeholder="Details">
                              </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="TravellingWith" class="form-control" placeholder="Family / Friends., etc">
                              </div>
                          </div>
...
function limitDate2(){
 ...
 document.getElementById("endDate").setAttribute("min",d1);
                        ...
                        <div class="col-md-4">
                        <input type="submit" value="Add Travel History" class="btn btn-primary">
