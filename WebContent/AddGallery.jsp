...
%>
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="AddGallery.jsp" class="logo"><img src="TravelMate_Logo.png" width="60" height="50"> <b>Travel Mate</b></a>
            <div class="top-menu">
...
%>
      ...
      <section id="main-content">
         ...
         <form action="AddMemoriesAction.jsp" method="post" enctype="multipart/form-data">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                ...
                                <div class="form-group">
                                  ...
                                  <td><input type="file" name="ProductPic" class="form-control" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])"></td>
