  ...
  <% 
             Admin a=AdminWorker.getAdminByAdminUserName(AdminUserName);
                 ...
                 <li class="sub-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <a class="active" href="UsersTravelHistory.jsp">
                          <i class=""></i>
      ...
      <section id="main-content">
          ...
          <button onclick="goBack()" class="btn btn-info btn-xs">Go Back</button>
          	...
          	<h3><i class="fa fa-angle-right"></i> Travel History of Registered Users</h3>

<%
List<TravelHistory> list=TravelHistoryWorker.getAllTravelHistory();
...
%>
                              ...
                              <tbody>
                                  <tr>
                                  <td><%= th.getId()%></td>
                                  <td><%= th.getUserName()%></td>
                                  <td><%= th.getTravelName()%></td>
                                  <td><%= th.getTravelLocation()%></td>
                                  <td><%= th.getTravelStartDate()%></td>
                                  <td><%= th.getTravelEndDate()%></td>
                                  <td><%= th.getModeOfTransportation()%></td>
                                  <td><%= th.getTravelDetails()%></td>
                                  <td><%= th.getTravellingWith()%></td>
