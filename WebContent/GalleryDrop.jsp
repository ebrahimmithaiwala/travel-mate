...
<body oncontextmenu="return false">
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="GalleryDrop.jsp" class="logo"><img src="TravelMate_Logo.png" width="60" height="50"> <b>Travel Mate</b></a>
            <div class="top-menu">
...
%>
                  ...
                  <form method="post" action="GalleryDropAction.jsp">
              ...
              <%
                ...
                try
                {
                	...
                	String Query="Select DISTINCT TravelName from memories" +" "+ "where UserName ="+ "'" + UserName + "'";
             ...
             %>
               ...
               <center>
               <input type="submit" name="action" value="Select" class="btn btn-success">
               </center>
               </a>
               </form>
                      </div><!-- /content-panel -->
